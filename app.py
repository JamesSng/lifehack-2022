...
app.add_url_rule('/org_profile/<user>', view_func = organiser_profile_view.organiser_profile, methods = ['GET', 'POST'])
app.add_url_rule('/event/<event>', view_func = user_event_view.user_event, methods = ['GET', 'POST'])
app.add_url_rule('/blogs', view_func = blog_list_view.blog_list, methods = ['GET', 'POST'])
